...
$local_desenvolvimento = $_POST["local_desenvolvimento"];
$titulo = $_POST["titulo"];
...
$local_desenvolvimento_xml = $xml->createElement("local_desenvolvimento", $local_desenvolvimento);
...
$dataenvio_xml = $xml->createElement("dataenvio", $tdataenvioitulo);
...
$dadosconteudo_xml->appendChild($local_desenvolvimento_xml);
